...
1. **No cerrar la app mientras F3 o `wit` estén trabajando.** Cancelá primero y esperá a que la fila diga Cancelado/Error antes de cerrar la ventana.
...
- F3 nunca arranca solo — siempre pide confirmación, y si no pasa, no te deja avanzar a Modo Fábrica.
